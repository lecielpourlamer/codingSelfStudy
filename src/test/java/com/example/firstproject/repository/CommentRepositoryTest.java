...
@DataJpaTest    // 해당 클래스를 JPA와 연동해서 테스팅
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        ...
        /* Case 3: 9번 게시글의 모든 댓글 조회 */
        {
            ...
            // 3. 예상 데이터
            Article article = null; // 실제로 9번 게시글이 없기 때문에 null
            List<Comment> expected = Arrays.asList();

            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "9번 글 자체가 없으므로 댓글을 비어 있어야 함");
        }
        ...
        /* Case 4: 999번 게시글의 모든 댓글 조회 */
        {
            ...
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "999번 글 자체가 없으므로 댓글을 비어 있어야 함");
        }
        ...
        /* Case 5: -1번 게시글의 모든 댓글 조회 */
        {
            ...
            // 4. 비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "-1번 글 자체가 없으므로 댓글을 비어 있어야 함");
        }
    }
